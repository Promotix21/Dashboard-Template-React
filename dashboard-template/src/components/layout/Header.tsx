...
import { Search, HelpCircle, Gift, Menu } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 bg-white/80 dark:bg-navy-950/90 backdrop-blur-md border-b border-cream-200 dark:border-navy-800 shadow-sm">
        <div className="flex items-center justify-between px-4 lg:px-8 py-4 gap-4">
          ...
          <motion.button
            ...
            className="lg:hidden p-2 rounded-lg text-navy-600 dark:text-cream-300 hover:bg-cream-100 dark:hover:bg-navy-800 transition-colors"
          ...
          <div className="flex items-center gap-1 lg:gap-2">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="relative flex items-center gap-2 px-3 py-2 rounded-lg text-navy-600 dark:text-cream-300 hover:bg-cream-100 dark:hover:bg-navy-800 transition-colors"
            >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="p-2 rounded-lg text-navy-600 dark:text-cream-300 hover:bg-cream-100 dark:hover:bg-navy-800 transition-colors"
              title="Help & Support"
            >
            ...
            {/* Divider */}
            <div className="w-px h-8 bg-cream-200 dark:bg-navy-700 hidden md:block"></div>
